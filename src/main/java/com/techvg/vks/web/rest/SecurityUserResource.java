...
import com.techvg.vks.repository.SecurityUserRepository;
import com.techvg.vks.service.SecurityUserQueryService;
import com.techvg.vks.service.SecurityUserService;
import com.techvg.vks.service.criteria.SecurityUserCriteria;
import com.techvg.vks.service.dto.SecurityUserDTO;
...
/**
 * REST controller for managing {@link com.techvg.vks.domain.SecurityUser}.
 */
@RestController
@RequestMapping("/api")
public class SecurityUserResource {
    ...
    public ResponseEntity<Long> countSecurityUsers(SecurityUserCriteria criteria) {
        log.debug("REST request to count SecurityUsers by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
