...
import com.techvg.vks.repository.NomineeRepository;
import com.techvg.vks.service.NomineeQueryService;
import com.techvg.vks.service.NomineeService;
import com.techvg.vks.service.criteria.NomineeCriteria;
...
/**
 * REST controller for managing {@link com.techvg.vks.domain.Nominee}.
 */
@RestController
@RequestMapping("/api")
public class NomineeResource {
    ...
    public ResponseEntity<NomineeDTO> updateNominee(
        ...
        NomineeDTO result = nomineeService.update(nomineeDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<NomineeDTO>> getAllNominees(
        ...
        log.debug("REST request to get Nominees by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countNominees(NomineeCriteria criteria) {
        log.debug("REST request to count Nominees by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
