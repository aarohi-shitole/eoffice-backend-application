...
import com.techvg.vks.repository.SecurityPermissionRepository;
import com.techvg.vks.service.SecurityPermissionQueryService;
import com.techvg.vks.service.SecurityPermissionService;
import com.techvg.vks.service.criteria.SecurityPermissionCriteria;
...
/**
 * REST controller for managing {@link com.techvg.vks.domain.SecurityPermission}.
 */
@RestController
@RequestMapping("/api")
public class SecurityPermissionResource {
    ...
    public ResponseEntity<List<SecurityPermissionDTO>> getAllSecurityPermissions(
        ...
        log.debug("REST request to get SecurityPermissions by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countSecurityPermissions(SecurityPermissionCriteria criteria) {
        log.debug("REST request to count SecurityPermissions by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
