...
import com.techvg.vks.repository.SecurityRoleRepository;
import com.techvg.vks.service.SecurityRoleQueryService;
import com.techvg.vks.service.SecurityRoleService;
import com.techvg.vks.service.criteria.SecurityRoleCriteria;
import com.techvg.vks.service.dto.SecurityRoleDTO;
...
/**
 * REST controller for managing {@link com.techvg.vks.domain.SecurityRole}.
 */
@RestController
@RequestMapping("/api")
public class SecurityRoleResource {
    ...
    public ResponseEntity<List<SecurityRoleDTO>> getAllSecurityRoles(
        ...
        log.debug("REST request to get SecurityRoles by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countSecurityRoles(SecurityRoleCriteria criteria) {
        log.debug("REST request to count SecurityRoles by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
