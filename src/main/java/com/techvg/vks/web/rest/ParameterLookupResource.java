...
import com.techvg.vks.repository.ParameterLookupRepository;
import com.techvg.vks.service.ParameterLookupQueryService;
import com.techvg.vks.service.ParameterLookupService;
import com.techvg.vks.service.criteria.ParameterLookupCriteria;
...
/**
 * REST controller for managing {@link com.techvg.vks.domain.ParameterLookup}.
 */
@RestController
@RequestMapping("/api")
public class ParameterLookupResource {
    ...
    public ResponseEntity<List<ParameterLookupDTO>> getAllParameterLookups(
        ...
        log.debug("REST request to get ParameterLookups by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countParameterLookups(ParameterLookupCriteria criteria) {
        log.debug("REST request to count ParameterLookups by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
